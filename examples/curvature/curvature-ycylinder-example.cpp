...
int main()
{
    std::cout << "\n---- curvature ycylinder example ----\n";

    Window window = window_create(800,600,"curvature ycylinder example");
    ...
    {
        Mesh mesh = load_model(std::string(OBJ_MODEL_DIR)+"/ycylinder.obj");
    ...
    std::cout<<"\n---- end curvature ycylinder example ----\n";
